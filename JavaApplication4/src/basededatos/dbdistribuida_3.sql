...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-07-2019 a las 19:54:34
...
--       `especial` -> `id_mad`
--   `id_certificacion`
--       `tipo_certificado` -> `id_certificado`
--   `id_colonia`
--       `colonia` -> `id_colonia`
--   `id_cede`
--       `cede` -> `id_cede`
...
--
-- RELACIONES PARA LA TABLA `colonia`:
--   `id_estado`
--       `estado` -> `id_estado`
--
...
--
-- RELACIONES PARA LA TABLA `detalle_horario`:
--   `id_salon`
--       `salon` -> `id_salon`
--   `id_grupo`
--       `grupo` -> `id_grupo`
--   `id_turno`
--       `turno_docente` -> `id_turno`
--   `id_alumno`
--       `alumno` -> `id_alumno`
--
...
--
-- RELACIONES PARA LA TABLA `especial`:
--   `id_materia`
--       `materia` -> `id_materia`
--
...
--
-- RELACIONES PARA LA TABLA `tipo_certificado`:
--
...
--
-- RELACIONES PARA LA TABLA `turno_docente`:
--
...
ALTER TABLE `alumno`
  ...
  ADD CONSTRAINT `alumno_ibfk_9` FOREIGN KEY (`id_cede`) REFERENCES `cede` (`id_cede`);
...
ALTER TABLE `detalle_horario`
  ...
  ADD CONSTRAINT `detalle_horario_ibfk_4` FOREIGN KEY (`id_alumno`) REFERENCES `alumno` (`id_alumno`);
...
ALTER TABLE `docente`
  ...
  ADD CONSTRAINT `docente_ibfk_5` FOREIGN KEY (`id_salon`) REFERENCES `salon` (`id_salon`);
