...
public class alumno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(1800, 840));
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Niguno", "Masculino", "Femenino" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Elije tu colonia" }));

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel2.setText("Dirección");

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Afirmativo", "Negativo" }));
        ...
        jLabel20.setText("Baucher copia ");
